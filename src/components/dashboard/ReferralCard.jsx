    ...
    <section id="referral" className="panel scroll-mt-20 p-4 md:p-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-ink-3">
            You both get <span className="font-medium text-yellow-text">20 EDC</span> after their first verified reward.
          </p>
        </div>
      ...
      <div className="mt-4 flex items-center justify-between rounded-lg bg-card px-3 py-2.5">
        ...
        <span className="flex items-center gap-2">
          ...
          <button type="button" onClick={copy} className="text-ink-3 transition-colors hover:text-yellow-text" aria-label="Copy referral link">
            <Copy size={14} />
          </button>
        </span>
      </div>
